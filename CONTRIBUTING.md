...
- Take a look at the Existing [Issues](https://github.com/rockingrohit9639/TextAnalyzer.git) or create your own Issues!
- Wait for the Issue to be assigned to you after which you can start working on it.
- Fork the Repo and create a Branch for any Issue that you are working upon.
- Read the [Code of Conduct](https://github.com/rockingrohit9639/TextAnalyzer.git)
...
- If you face any error use the **textAnalyzer.sh** script present in the root directory of the project.


## ⭐HOW TO MAKE A PULL REQUEST :

**1.** Fork [this](https://github.com/rockingrohit9639/TextAnalyzer.git) repository.
Click on the <a href="https://github.com/rockingrohit9639/TextAnalyzer.git"><img src="https://img.icons8.com/ios/24/000000/code-fork.png"></a> symbol at the top right corner.
